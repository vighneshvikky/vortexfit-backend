...
import { IPlanService, IPLANSERVICE } from '../services/interface/plan.service.interface';
import { CreatePlanDto } from '../dtos/plan.dto';


@Controller('plans')
export class PlanController {
  constructor(@Inject(IPLANSERVICE) private readonly _planService: IPlanService) {}
  ...
  async softDelete(@Param('id') id: string) {
    return this._planService.softDeletePlan(id);
  }
}
